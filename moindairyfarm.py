...
if open_close_status == "Open" and st.button("Submit"):
    ...
    data = {
        ...
        "Liters of Milk Purchased": [liters_purchased],
...
elif open_close_status == "Close" and st.button("Close Customer"):
